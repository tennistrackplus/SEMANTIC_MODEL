...
explore: demo {
  ...
  join: ceco {
    sql_on: ${demo_fact.CECO} = ${ceco.ceco} ;;
    relationship: many_to_one
  }

  join: cuenta {
    sql_on: ${demo_fact.CUENTA} = ${cuenta.cuenta} ;;
    relationship: many_to_one
  }

  join: escenario {
    sql_on: ${demo_fact.ESCENARIO} = ${escenario.escenario} ;;
    relationship: many_to_one
  }

  join: year {
    sql_on: ${demo_fact.YEAR} = ${year.year} ;;
    relationship: many_to_one
  }

  join: period {
    sql_on: ${demo_fact.PERIOD} = ${period.period} ;;
    relationship: many_to_one
  }
